...
class SuppliersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supplier" do
    assert_difference('Supplier.count') do
      post suppliers_url, params: { supplier: { cnpj: @supplier.cnpj, modified_at: @supplier.modified_at, title: @supplier.title } }
    end
  ...
  test "should update supplier" do
    patch supplier_url(@supplier), params: { supplier: { cnpj: @supplier.cnpj, modified_at: @supplier.modified_at, title: @supplier.title } }
